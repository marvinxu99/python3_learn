...
- Describes location in absolute and/or relative terms

CONs:
- Difficult to manage a large number of widgets if parent is re-sized.
...
# create a 640x480 window to be placed at (200,200)
